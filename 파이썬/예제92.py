...
클래스(Class)는 객체 지향 프로그래밍(OOP, Object-Oriented Programming)에서
객체(Object)를 만들기 위한 설계도(템플릿) 역할을 합니다.

파이썬에서 클래스는 class 키워드를 사용하여 정의되며, 
클래스 내부에는 속성(변수)과 메서드(함수)가 포함될 수 있습니다.
...
예제.  내가 영화 할인 카드 프로그램을 개발해야하는데 그럴러면 카드의 기본기능을
       ...
       코드를 상속받기만하면 되고 내가 구현야할 영화 할인에만 집중해서 코드를 작성하면 됩니다.
