...
=============================================================================
🎨 **상관계수 개념 그림**  
📷 이미지: [상관계수 시각화](https://github.com/oracleyu01/python_class/blob/main/3유형/상관계수.png)  
...
=============================================================================
✅ **용도**  
- **순서형(ordinal) 데이터**나 **정규성을 따르지 않는 데이터**에서 **순위 기반** 상관관계를 측정할 때 사용.  
...
=============================================================================
✅ **정의**  
- 두 변수 간의 관계를 **시각적으로 표현**하는 그래프.  

✅ **특징**  
- x축과 y축에 각각 한 변수씩 배치하여 **분포와 관계를 확인**.  

✅ **관계 확인**  
- 데이터 포인트들이 직선에 가까운 패턴을 보이면 **선형관계**가 있다고 해석 가능.  

✅ **적용 대상**  
- **수치형 데이터**의 관계를 시각적으로 표현하는 데 적합.  

✅ **주의**  
- **범주형 데이터**는 크기나 순서가 없으므로, **막대그래프 또는 원형그래프**가 더 적합.  

=============================================================================
📌 기출문제 정리 - 빅데이터분석기사 필기
=============================================================================

● **문제 1: 상관계수의 해석으로 옳은 것은?**  
  ...
  **정답: 2) 상관계수가 +1은 완벽한 양의 선형 상관관계를 의미한다**  

  **해설:**  
  - 피어슨 상관계수의 값은 **-1에서 +1 사이**이며,  
  - **+1은 완벽한 양의 선형 관계**, **-1은 완벽한 음의 선형 관계**를 의미.  
  - **0이면 선형 관계가 없지만, 비선형 관계는 존재할 수 있음**.  
  - **스피어만 상관계수는 실제 값이 아니라 순위를 기반으로 계산됨**.  

-----------------------------------------------------------------------------

● **문제 2: 산점도에 대한 설명으로 옳지 않은 것은?**  
  ...
  **정답: 4) 범주형 데이터 분석에 가장 적합하다**  

  **해설:**  
  - 산점도는 **수치형 변수 간의 관계**를 분석하는 시각화 방법.  
  - 범주형 데이터 분석에는 **막대그래프, 원형그래프**가 더 적합함.  

-----------------------------------------------------------------------------

● **문제 3: 상관분석 방법으로 옳지 않은 것은?**  
  ...
  **정답: 4) 모든 데이터는 피어슨 상관계수로 분석한다**  

  **해설:**  
  - **피어슨 상관계수**는 **수치형 데이터**에 사용됨.  
  - **스피어만 상관계수**는 **순서형 데이터**나 정규성을 따르지 않는 데이터에 적합.  
  - **명목형(범주형) 데이터**는 **카이제곱 검정**을 사용하여 분석해야 함.  
