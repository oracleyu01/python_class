...
6. 📝 Adsp, 빅데이터 분석기사 국가 기술 자격증 문제 풀이
7. 🏆 데이콘 상위권 도전!
...
### 🐼 데이터 조작 및 전처리 (Pandas) 
- **예제0. 파이썬 설치**: 📄[노트](https://github.com/oracleyu01/python_class/blob/main/yys/%EC%98%88%EC%A0%9C0.%ED%8C%8C%EC%9D%B4%EC%8D%AC_%EC%84%A4%EC%B9%98.md)  
- **예제1. 판다스 모듈이란**:  📄[노트]()  
- **예제2. 특정 컬럼 출력하기**:  📄[노트]()  
